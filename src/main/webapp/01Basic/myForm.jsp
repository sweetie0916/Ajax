...
/* <form> 하위 태그가 아닌 a, img와 같은 태그에서는 this를 사용할 수 없으므로 
...
<form name="frm" method="post" action="formSubmit.jsp">
	...
	<input type="text" name="good" id="good" value="좋아요" />
	
	<input type="submit" value="전송(only HTML)" />
	
	<input type="button" value="전송(with Javascript)" onclick="jsSubmit(this.form);" />
	
	<a href="javascript:imgSubmit()"><img src="../images/button.jpg" alt="나는야버튼" /></a>
